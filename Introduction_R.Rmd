...
Two commands were added to the command line: 1. *coord_flip()*: changes the axis 2. *Scale_fill_brewer()*: changes the color palette. The palette used in this example is "Paired" but others can be found, please go to [this link](https://www.r-graph-gallery.com/38-rcolorbrewers-palettes.html)
